...
export function ToolsEducation() {
  ...
  const AVAILABLE_TOOLS = [
    ...
    {
      name: t("tools.availableTools.copyAndEnterFn.name"),
      description: t("tools.availableTools.copyAndEnterFn.description"),
    },
    {
      name: t("tools.availableTools.pressEnterFn.name"),
      description: t("tools.availableTools.pressEnterFn.description"),
    },
    {
